...
//   const onTriggerPopup = () => setPopupState
//   (!popupState);
...
//             <img src={logo} alt='logo/img' className='w-22 h-9 ibject-fill'/>
//           </NavLink>
...
//             <li><button type='button' className='button-emrald px-7 text-base py-1'>Join Us</button></li>
//           </ul>
//           <ul className='hidden lg:flex items-center'>
//             <li button type='button' className='flex items-center justify-center transition-all duration-200 active:scale-90 cursor-pointer' onClick={onTriggerPopup}><img src={menu} alt='menu/svg' className='object-cover shadow-sm filter'/></li>
//           </ul>
//         </nav>
//       </header>
